...
```
API_URL_S=<URL de la API Chess S>
USERNAME_S=<Usuario para Chess S>
PASSWORD_S=<Contraseña para Chess S>
API_URL_B=<URL de la API Chess B>
USERNAME_B=<Usuario para Chess B>
PASSWORD_B=<Contraseña para Chess B>
```
...
# Inicializar cliente
client = ChessClient(
    api_url=settings.api_url_s,
    username=settings.username_s,
    password=settings.password_s
)

# Obtener datos de ventas
sales = client.get_sales(date_from="2025-01-01", date_to="2025-01-31")
```
